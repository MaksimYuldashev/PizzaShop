import style from "../style/LoadingPage.module.css";
    ...
    return (
        <section className="container mx-auto flex items-center justify-center h-screen">
            <div>
                ...
                >
                    <g className={style.pizza}>
                        <rect width="240" height="240" fill="none"></rect>
                        <g className={style.slice6}>
                            <g className={style.slice}>
                                <mask className="path-1-insclassNamee-1_7_2" fill="white">
                                    <path
                                ...
                                <path
                                    ...
                                    stroke="#EE9758"
                                    strokeWidth="2"
                                    mask="url(#path-1-insclassNamee-1_7_2)"
                                ></path>
                            </g>
                            <g className={style.pepperoni}>
                                <circle cx="114" cy="63" r="6" fill="#F12424"></circle>
                                <circle cx="114" cy="63" r="6" fill="#F12424"></circle>
                            </g>
                            <g className={style.mushroom}>
                                <path
                        ...
                        <g className={style.slice5}>
                            <g className="slice_2">
                                <mask className="path-7-insclassNamee-2_7_2" fill="white">
                                    <path
                                ...
                                <path
                                    ...
                                    stroke="#EE9758"
                                    strokeWidth="2"
                                    mask="url(#path-7-insclassNamee-2_7_2)"
                                ></path>
                            </g>
                            <g className={style.pepperoni_2}>
                                <circle cx="82" cy="56" r="6" fill="#F12424"></circle>
                                <circle cx="82" cy="56" r="6" fill="#F12424"></circle>
                            </g>
                            <g className={style.mushroom_2}>
                                <path
                        ...
                        <g className={style.slice1}>
                            <g className={style.slice_3}>
                                <mask className="path-13-insclassNamee-3_7_2" fill="white">
                                    <path
                                ...
                                <path
                                    ...
                                    stroke="#EE9758"
                                    strokeWidth="2"
                                    mask="url(#path-13-insclassNamee-3_7_2)"
                                ></path>
                            </g>
                            <g className={style.pepperoni_3}>
                                <circle cx="119" cy="99" r="6" fill="#F12424"></circle>
                                <circle cx="119" cy="99" r="6" fill="#F12424"></circle>
                            </g>
                            <path
                                className={style.pepper_3}
                        ...
                        <g className={style.slice2}>
                            <g className={style.slice_4}>
                                <mask className="path-17-insclassNamee-4_7_2" fill="white">
                                    <path
                                ...
                                <path
                                    ...
                                    stroke="#EE9758"
                                    strokeWidth="2"
                                    mask="url(#path-17-insclassNamee-4_7_2)"
                                ></path>
                            </g>
                            <g className={style.pepperoni_4}>
                                <circle cx="78" cy="103" r="6" fill="#F12424"></circle>
                                <circle cx="78" cy="103" r="6" fill="#F12424"></circle>
                            </g>
                            <g className={style.mushroom_3}>
                                <path
                        ...
                        <g className={style.slice4}>
                            <g className={style.slice_5}>
                                <mask className="path-23-insclassNamee-5_7_2" fill="white">
                                    <path
                                ...
                                <path
                                    ...
                                    stroke="#EE9758"
                                    strokeWidth="2"
                                    mask="url(#path-23-insclassNamee-5_7_2)"
                                ></path>
                            </g>
                            <g className={style.pepperoni_5}>
                                <circle cx="64" cy="70" r="6" fill="#F12424"></circle>
                                <circle cx="64" cy="70" r="6" fill="#F12424"></circle>
                            </g>
                            <g className={style.mushroom_4}>
                                <path
                        ...
                        <g className={style.slice3}>
                            <g className={style.slice_6}>
                                <mask className="path-29-insclassNamee-6_7_2" fill="white">
                                    <path
                                ...
                                <path
                                    ...
                                    stroke="#EE9758"
                                    strokeWidth="2"
                                    mask="url(#path-29-insclassNamee-6_7_2)"
                                ></path>
                            </g>
                            <g className={style.pepperoni_6}>
                                <circle cx="42" cy="99" r="6" fill="#F12424"></circle>
                                <circle cx="42" cy="99" r="6" fill="#F12424"></circle>
                            </g>
                            <g className={style.mushroom_5}>
                                <path
